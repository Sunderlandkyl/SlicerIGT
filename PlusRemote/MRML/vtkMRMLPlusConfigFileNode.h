...
#ifndef __vtkMRMLPlusConfigFileNode_h
#define __vtkMRMLPlusConfigFileNode_h
...
class VTK_SLICER_PLUSREMOTE_MODULE_MRML_EXPORT vtkMRMLPlusConfigFileNode : public vtkMRMLStorageNode
{
public:
  ...
  static vtkMRMLPlusConfigFileNode* New();
  vtkTypeMacro(vtkMRMLPlusConfigFileNode, vtkMRMLStorageNode);
...
protected:
  ...
  vtkMRMLPlusConfigFileNode();
  ~vtkMRMLPlusConfigFileNode();
  vtkMRMLPlusConfigFileNode(const vtkMRMLPlusConfigFileNode&);
  void operator=(const vtkMRMLPlusConfigFileNode&);
